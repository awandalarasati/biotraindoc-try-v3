        ...
        <div class="flex-1 flex items-center justify-center">
            <div class="bg-white shadow-lg rounded-xl p-8 md:p-10 w-full max-w-md">
                ...
                <div class="text-center">
                    <p class="text-2xl font-bold text-[#029dbb] mb-5">Silakan daftar akun</p>
                </div>
                ...
                <form method="POST" action="{{ route('register') }}">
                    @csrf
                    <div class="mb-4">
                        <label for="name" class="block text-sm font-semibold text-[#029dbb] mb-2">Nama Lengkap</label>
                        <input type="text" id="name" name="name" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-400" required>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="email" id="email" name="email" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-cyan-400" required>
                    </div>
                    ...
                    <div class="mb-6 relative-input">
                        ...
                        <input type="password" id="password_confirmation" name="password_confirmation" class="w-full px-4 py-3 border border-gray-300 rounded-lg pr-12 focus:outline-none focus:ring-2 focus:ring-cyan-400" required>
                ...
                <div class="mt-5 text-center text-sm">
                    <a href="{{ route('login') }}" class="text-[#029dbb] hover:underline">Sudah memiliki akun? login di sini</a>
                </div>
            </div>
        </div>
    </div>
